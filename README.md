# Animals App using React

## In this Animals project list and keys are practised, working with different components. Passing data and routing.

- A list of animal cards are displayed in the Animals page. Where by clicking the Read more link ion the cards it will display the HD image version of that particular animal.
